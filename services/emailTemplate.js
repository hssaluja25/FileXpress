...
<body class=""
  ...
  <span class="preheader"
    style="color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;">A file was shared to you!</span>
                  ...
                  <tr>
                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                      ...
                      <p
                        ...
                        If the button doesn't work, copy the following link and paste in in your browser. <a href="http://">${downloadLink}</a> <br>The link will expire in ${expires}.</p>
                      <p
                        style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                        Thank you for using FileXpress!</p>
                        <br>
                      <p
                        style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                        Regards, Harpreet</p>
              ...
              <tr>
                <td class="content-block powered-by"
                  ...
                  Powered by <a href="${siteLink}"
                    style="color: #999999; font-size: 12px; text-align: center; text-decoration: none;">FileXpress</a>.
                </td>
              </tr>
            </table>
          </div>
